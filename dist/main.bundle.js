...
var SlidegalleryComponent = (function () {
    ...
    SlidegalleryComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loadImageList();
        var timer = __WEBPACK_IMPORTED_MODULE_2_rxjs_observable_TimerObservable__["a" /* TimerObservable */].create(1000, 60000);
        var timer_slide = __WEBPACK_IMPORTED_MODULE_2_rxjs_observable_TimerObservable__["a" /* TimerObservable */].create(5000, 5000);
        this.subscription = timer.subscribe(function () {
            _this.loadImageList();
        });
        this.subscription_slide = timer_slide.subscribe(function () {
            var total = _this.images.length - 1;
            _this.counter = _this.click_next(total);
        });
    };
